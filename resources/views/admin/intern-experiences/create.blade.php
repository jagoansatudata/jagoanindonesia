...
@section('title', 'Add Intern Experience')
...
@section('content')
    <div class="mb-6">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-semibold text-gray-900">Add New Intern Experience</h1>
        </div>
    </div>

    <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
        <form action="{{ route('intern-experiences.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="intern_name" class="block text-sm font-medium text-gray-700 mb-1">Intern Name *</label>
                    <input type="text" id="intern_name" name="intern_name" value="{{ old('intern_name') }}" required
                ...
                <div>
                    ...
                    <input type="text" id="intern_role" name="intern_role" value="{{ old('intern_role') }}"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
                ...
                <textarea id="experience_content" name="experience_content" rows="4" maxlength="200" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Enter the experience content..." oninput="updateCharCount()">{{ old('experience_content') }}</textarea>
