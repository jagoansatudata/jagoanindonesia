...
@section('content')
    <div class="mb-6">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-semibold text-gray-900">Add New Hero Section</h1>
        </div>
    </div>
        ...
        <form action="{{ route('admin.hero-sections.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            ...
            <div>
                ...
                <textarea id="subtitle" name="subtitle" rows="3" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="Enter hero subtitle">{{ old('subtitle') }}</textarea>
                @error('subtitle')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="text" id="button_text" name="button_text" value="{{ old('button_text') }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
                ...
                <input type="text" id="button_url" name="button_url" value="{{ old('button_url') }}" required
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div>
                ...
                <div class="text-sm text-gray-500 mt-2">
                    ...
                    <p>Leave empty to use default background image</p>
                </div>
