                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($university->logo_url)
                                    <div class="h-10 w-10 bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
                                        <img src="{{ $university->logo_url }}" alt="{{ $university->name }}" class="h-10 w-10 object-cover" onerror="this.style.display='none'; const fb=this.parentElement.querySelector('[data-img-fallback]'); if(fb){ fb.style.display='block'; }" />
