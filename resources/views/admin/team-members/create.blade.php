...
@section('content')
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-900">Create Team Member</h1>
        <p class="text-sm text-gray-600 mt-1">Add a new team member to display on the Home page.</p>
    </div>

    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm">
        <form action="{{ route('team-members.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
