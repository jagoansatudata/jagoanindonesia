...
Route::get('/storage/images/hero/{filename}', function (string $filename) {
    $filename = basename($filename);
...
Route::get('/storage/universities/{filename}', function (string $filename) {
    $filename = basename($filename);
...
Route::get('/storage/intern-avatars/{filename}', function (string $filename) {
    $filename = basename($filename);
    $path = 'intern-avatars/' . $filename;
